...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_SIGNIN_AUTH_DOMAIN,
  projectId: import.meta.env.VITE_SIGNIN_PROJECT_ID,
  storageBucket: import.meta.env.VITE_SIGNIN_STORAGE_BUCKET,
  messagingSenderId: import.meta.env.VITE_SIGNIN_MESSAGING_SENDER_ID,
  appId: import.meta.env.VITE_SIGNIN_APP_ID
};
