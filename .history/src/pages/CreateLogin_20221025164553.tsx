...
export function CreateLogin() {
  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      ...
      <div className='bg-gray-800 w-[420px] h-[300px] flex flex-col items-center gap-16 rounded shadow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
        <Text size='lg' className='mt-4'>Conta criada com sucesso!</Text>
