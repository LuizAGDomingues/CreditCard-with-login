...
export function CreateLogin() {
  ...
  const [rePassoword, setRePassoword] = useState('');
      ...
      <form onSubmit={handleCreateLogin} className='flex flex-col items-stretch w-full gap-4 max-w-sm mt-10'>
        ...
        <label htmlFor="password" className='flex flex-col gap-3'>
          ...
          <TextInput.Root>
            ...
            <TextInput.Input type='password' id='password' placeholder='********' onChange={(e) => setEmail(e.target.value)}/>
          </TextInput.Root>
        </label>
        <label htmlFor="password" className='flex flex-col gap-3'>
          ...
          <TextInput.Root>
            ...
            <TextInput.Input type='password' id='rePassword' placeholder='********' onChange={(e) => setEmail(e.target.value)}/>
          </TextInput.Root>
        </label>
        <CreateLoginModal accountName={accountName} />
      </form>
    </div>
  )
}
