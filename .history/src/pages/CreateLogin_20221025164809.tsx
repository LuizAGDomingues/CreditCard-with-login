...
export function CreateLogin() {
  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      ...
      <div className='bg-gray-800 w-[420px] h-[300px] flex flex-col items-center justify-between rounded border border-cyan-300 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
        <Text size='lg' className='mt-3'>Conta criada com sucesso!</Text>
        <Text>Seja bem vindo {accountName}</Text>
        <button className='mb-5'>Continuar</button>
      </div>
    </div>
  )
}
