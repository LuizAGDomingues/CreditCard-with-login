    ...
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      ...
      { enableModalError ?
        <Modal>
          ...
          <button type='button' onClick={(e) => setEnableModalError(true)} className='mb-5 py-2 px-3 bg-cyan-300 rounded font-semibold text-black text-sm transition-colors hover:ring-2 focus:ring-2 ring-white'>Ok</button>
        </Modal>
      }
    </div>
  )
